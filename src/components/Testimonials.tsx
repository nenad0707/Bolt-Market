          ...
          >
            {extendedTestimonials.map((item, index) => (
              <div key={index} className="p-4 md:w-1/3 w-full flex-shrink-0">
                <div className="h-[300px] bg-indigo-50 p-6 rounded-lg shadow-lg flex flex-col justify-between">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className="block w-8 h-8 text-indigoBlue mb-4 mx-auto"
                  ...
                  <p className="text-center leading-relaxed mb-4 text-gray-700">
                    {item.testimony}
                  </p>
                  ...
                  <div className="flex items-center justify-center">
                    <img
                      alt={item.name}
                      src={item.image}
                      className="w-12 h-12 rounded-full object-cover border-2 border-indigoBlue"
                    />
                    <div className="ml-4 text-center">
                      <h3 className="font-medium text-indigoBlue">
                        {item.name}
                      </h3>
